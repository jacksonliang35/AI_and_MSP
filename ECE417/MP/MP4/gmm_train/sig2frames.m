...
for i = 1:Nf
    ...
    end_sample = start_sample+Nw-1;
    frames(:, i) = win.*signal(start_sample:end_sample);
end
%{
start_sample = i*(Nw-No)+1;
last_frame=signal(start_sample:end);
frames(1:length(last_frame),end)=last_frame;
%}
end
