...
%% Import Rects & Images
% load rects
totalrects = load('../rects/allrects.txt','-ascii');
% load images
JPGDIR = '../jpg';
files = dir(JPGDIR);
...
hold on
plot(totalerr,'-k','LineWidth',2,'DisplayName','Unweighted Error of Strong Classifier')
plot(singleerr,'--k','LineWidth',2,'DisplayName','Unweighted Error of Weak Classifier')
plot(beta./(1+beta),'-.k','LineWidth',2,'DisplayName','Weighted Error Rate')
legend show
